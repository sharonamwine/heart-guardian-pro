    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <div className="mt-6">
          <Link
            to="/"
            className="inline-flex items-center justify-center rounded-xl bg-gradient-primary px-5 py-2.5 text-sm font-semibold text-primary-foreground shadow-glow transition-smooth hover:opacity-90"
          >
            Go home
          </Link>
        </div>
  ...
  head: () => ({
    meta: [
      ...
      { title: "CareSync HIV — Smart Adherence & Treatment Support System" },
      {
        name: "description",
        content:
          "CareSync HIV — Smart Adherence & Treatment Support System with medication monitoring, adherence tracking, and care team support.",
      },
      { property: "og:title", content: "CareSync HIV — Smart Adherence & Treatment Support System" },
